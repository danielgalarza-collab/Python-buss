...
# uso de la "f" , La f delante de una cadena en Python sirve para meter variables dentro del texto fácilmente.
#Por ejemplo:
nombre = "Alejandro"
print(f"Hola, {nombre}!")
...
# Recorremos el diccionario 'familia' con sus claves y valores
for x, obj in familia.items():  
    # Imprimimos el nombre de la persona (la clave principal)
    print(x)  
    
    # Recorremos el diccionario interno que contiene los datos de esa persona
    for y in obj:  
        # Imprimimos cada dato con su nombre capitalizado y su valor
        # Ejemplo: "Edad: 45" o "Profesion: ingeniero"
